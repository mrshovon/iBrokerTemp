...
var KTAppDemos = (function () {
    ...
    return {
        init: function () {
            (e = document.querySelector("#kt_app_demos")) &&
                ((n = document.querySelector("#kt_app_demos_sidebar_sticky_wrapper")),
                ...
                e.querySelectorAll('[data-kt-toggle="tab"]').forEach((e) => {
                    e.addEventListener("click", function (n) {
                        KTUtil.isDesktopDevice() && "on" === document.body.getAttribute("data-kt-demos-sidebar-sticky")
                            ? (window.scrollTo({ top: 0, behavior: "smooth" }), t.update(), bootstrap.Tab.getOrCreateInstance(e).show())
                            : bootstrap.Tab.getOrCreateInstance(e).show();
                    });
                }),
                (function () {
                    KTUtil.on(e, '[data-kt-demos-grid-toggle="true"]', "click", function (e) {
                        ...
                        KTCookie.set("app_demos_grid_mode", t, { expires: i }),
                        ...
                        [].slice.call(document.querySelectorAll('[data-kt-grid-col="true"]')).map(function (t) {
                            "3" === n
                                ? (t.classList.add("col-md-4"),
                                  ...
                                  r.setAttribute("data-kt-sticky-width", "50px"))
                                : (t.classList.add("col-md-6"),
...
var KTAppHero = (function () {
    var e,
        ...
        a = function (e) {
            ...
            KTUtil.css(r, "width", `${n}%`), KTUtil.css(t, "left", `calc(${n}% - 0px)`);
        },
        l = function () {
            const t = KTUtil.css(e, "width");
            KTUtil.css(i, "width", t), KTUtil.css(o, "width", t);
        },
        s = function () {
    ...
    return {
        init: function () {
            (e = document.querySelector(".preview")),
                ...
                e && (l(), s(), n.addEventListener("input", a), n.addEventListener("change", a));
        },
    };
})();
KTUtil.onDOMContentLoaded(function () {
